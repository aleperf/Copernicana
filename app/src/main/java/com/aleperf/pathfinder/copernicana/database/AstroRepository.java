...
public interface AstroRepository {
    ...
    String ASTRONAUT_FAILED_CONNECTION = "failed connection in AstroRepository 123";
    String EPIC_NO_DATA = "No data for epic 1343";
    String EPIC_FAILURE_ON_CONNECTION = "failure on connection for epic 34343";
