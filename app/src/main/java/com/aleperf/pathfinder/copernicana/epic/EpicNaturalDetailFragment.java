...
public class EpicNaturalDetailFragment extends Fragment {
    ...
    public EpicNaturalDetailFragment() {
    }


    public static EpicNaturalDetailFragment getInstance(Epic epic) {
        Bundle bundle = new Bundle();
        bundle.putParcelable(CURRENT_EPIC, epic);
        EpicNaturalDetailFragment fragment = new EpicNaturalDetailFragment();
